...
`)+`
`+f);const T=E+p+o,x=E+f+a,w=ml(s,s.VERTEX_SHADER,T),A=ml(s,s.FRAGMENT_SHADER,x);s.attachShader(M,w),s.attachShader(M,A),e.index0AttributeName!==void 0?s.bindAttribLocation(M,0,e.index0AttributeName):e.morphTargets===!0&&s.bindAttribLocation(M,0,"position"),s.linkProgram(M);function C(L){if(i.debug.checkShaderErrors){const U=s.getProgramInfoLog(M)||"",B=s.getShaderInfoLog(w)||"",Y=s.getShaderInfoLog(A)||"",V=U.trim(),W=B.trim(),K=Y.trim();let H=!0,ot=!0;if(s.getProgramParameter(M,s.LINK_STATUS)===!1)if(H=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,M,w,A);else{const ht=_l(s,w,"vertex"),Et=_l(s,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(M,s.VALIDATE_STATUS)+`
